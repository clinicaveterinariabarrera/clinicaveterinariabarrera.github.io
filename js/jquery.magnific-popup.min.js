...
(function(e) {
    ...
    w.prototype = {
        ...
        open: function(i) {
            ...
            T("BeforeOpen"),
            t.st.showCloseBtn && (t.st.closeBtnInside ? (x(p, function(e, t, i, n) {
            ...
            setTimeout(function() {
                ...
                E()) : t.bgOverlay.addClass(h),
                o.on("focusin" + v, function(i) {
                    return i.target === t.wrap[0] || e.contains(t.wrap[0], i.target) ? void 0 : (E(),
                    !1)
                })
            }, 16),
            t.isOpen = !0,
        ...
        updateItemHTML: function() {
            ...
            var n = i.type;
            if (T("BeforeChange", [t.currItem ? t.currItem.type : "", n]),
            t.currItem = i,
            !t.currTemplate[n]) {
    ...
    e.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function(i) {
                ...
                return Z() ? s["-moz-transform"] = s.transform = "translate(" + o.left + "px," + o.top + "px)" : (s.left = o.left,
                s.top = o.top),
                s
            }
        }
            ...
            initRetina: function() {
                if (window.devicePixelRatio > 1) {
                    var e = t.st.retina
                      , i = e.ratio;
                    i = isNaN(i) ? i() : i,
                    i > 1 && (x("ImageHasSize." + G, function(e, t) {
                        t.img.css({
