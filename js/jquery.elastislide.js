(function(j, c, l) {
        ...
        this.each(function() {
            ...
            function c(h) {
                ...
                if (k) {
                    ...
                    Math.abs(f) >= b.min_move_x ? (a(),
                    0 < f ? b.wipeLeft() : b.wipeRight()) : Math.abs(h) >= b.min_move_y && (a(),
                    0 < h ? b.wipeDown() : b.wipeUp())
                }
            }
            function f(a) {
                1 == a.touches.length && (d = a.touches[0].pageX,
                e = a.touches[0].pageY,
                k = !0,
    ...
    c.elastislide.prototype = {
        ...
        _validateOptions: function() {
            ...
            if (1 > this.options.minItems || this.options.minItems > this.itemsCount)
        ...
        _configure: function() {
            ...
            this.visibleWidth < this.options.minItems * (this.options.imageW + 2 * this.options.border) + (this.options.minItems - 1) * this.options.margin ? (this._setDim((this.visibleWidth - (this.options.minItems - 1) * this.options.margin) / this.options.minItems),
            this._setCurrentValues(),
            this.fitCount = this.options.minItems) : (this._setDim(),
            this._setCurrentValues());
            this.$slider.css({
                width: this.sliderW
            })
        ...
        _initEvents: function() {
            ...
            c(j).bind("resize.elastislide", function() {
                a._setCurrentValues();
                a.visibleWidth < a.options.minItems * (a.options.imageW + 2 * a.options.border) + (a.options.minItems - 1) * a.options.margin ? (a._setDim((a.visibleWidth - (a.options.minItems - 1) * a.options.margin) / a.options.minItems),
                a._setCurrentValues(),
                a.fitCount = a.options.minItems) : (a._setDim(),
                a._setCurrentValues());
                a.$slider.css({
                    width: a.sliderW + 10
                });
        ...
        _slide: function(a, b, g, j) {
            ...
            if (b === l) {
                ...
                if (0 > d)
                    return !1;
                if ("right" === a && this.sliderW - (Math.abs(f) + d) < this.visibleWidth)
                    d = this.sliderW - (Math.abs(f) + this.visibleWidth) - this.options.margin,
                    this._toggleControls("right", -1),
                    this._toggleControls("left", 1);
                else if ("left" === a && 0 > Math.abs(f) - d)
                    d = Math.abs(f),
                    this._toggleControls("left", -1),
                    this._toggleControls("right", 1);
                else {
                ...
                e = Math.abs(b),
                Math.max(this.sliderW, this.visibleWidth) - e < this.visibleWidth && (b = -(Math.max(this.sliderW, this.visibleWidth) - this.visibleWidth),
                0 !== b && (b += this.options.margin),
                this._toggleControls("right", -1),
                e = Math.abs(b)),
                0 < e ? this._toggleControls("left", 1) : this._toggleControls("left", -1),
                Math.max(this.sliderW, this.visibleWidth) - this.visibleWidth > e + this.options.margin ? this._toggleControls("right", 1) : this._toggleControls("right", -1);
